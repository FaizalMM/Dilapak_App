      ...
      body: IndexedStack(
        ...
        children: [
          _isVerified
              ...
              : _UnverifiedDashboard(onVerified: _onVerified),
...
class _UnverifiedDashboard extends StatelessWidget {
  ...
  const _UnverifiedDashboard({required this.onVerified});
            ...
            child: SingleChildScrollView(
              ...
              child: Column(
                ...
                children: [
                  ...
                  _ProgressSection(onVerified: onVerified),
                  const SizedBox(height: 24),
...
class _ProgressSection extends StatelessWidget {
  ...
  const _ProgressSection({required this.onVerified});
          ...
          child: Column(
            children: [
              ...
              _ProgressItem(
                ...
                subtitle: 'Kirim kode verifikasi ke nomor WhatsApp Anda.',
              ...
              _ProgressItem(
                ...
                subtitle: 'Terbuka setelah WhatsApp terverifikasi.',
...
class _KategoriLayanan extends StatelessWidget {
  static const List<_KategoriItem> _items = [
    _KategoriItem(icon: Icons.badge_outlined, label: 'Kependudukan'),
    _KategoriItem(icon: Icons.description_outlined, label: 'Perizinan'),
    _KategoriItem(icon: Icons.health_and_safety_outlined, label: 'Kesehatan'),
    _KategoriItem(icon: Icons.school_outlined, label: 'Pendidikan'),
  ];
  ...
  Widget build(BuildContext context) {
    return Row(
      mainAxisAlignment: MainAxisAlignment.spaceBetween,
      children: _items
          .map((item) => _KategoriCard(icon: item.icon, label: item.label))
          .toList(),
    );
  }
}
...
class _PermohonanList extends StatelessWidget {
  static const List<_PermohonanItem> _items = [
    _PermohonanItem(
      icon: Icons.description_outlined,
      title: 'Pembuatan KK Baru',
      date: '24 Okt 2023',
      status: 'Diproses',
      statusColor: Color(0xFF2D7DD2),
    ),
    _PermohonanItem(
  ...
  void _showLogoutDialog(BuildContext context) {
    showDialog(
      ...
      builder: (ctx) => AlertDialog(
        ...
        content: Text(
          'Apakah Anda yakin ingin keluar dari akun Dilapak?',
          style: GoogleFonts.plusJakartaSans(
            fontSize: 13,
            color: AppColors.textSecondary,
            height: 1.5,
        ...
        children: [
          if (isActive)
            Container(
              ...
              child: Icon(item.activeIcon, color: AppColors.white, size: 20),
            )
          else
            SizedBox(
              width: 48,
          ...
          Text(
            ...
            style: GoogleFonts.plusJakartaSans(
              ...
              color: isActive ? AppColors.dilapakTeal : AppColors.textMuted,
            ),
          ),
        ],
      ),
