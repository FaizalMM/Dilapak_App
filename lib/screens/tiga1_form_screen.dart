...
class _Tiga1FormScreenState extends State<Tiga1FormScreen> {
  ...
  Future<void> _pickLayanan(int slot) async {
    final current = slot == 1
        ? _layanan1
        : slot == 2
            ? _layanan2
            : _layanan3;
    final result =
        await LayananPickerSheet.show(context, selectedLayanan: current);
    if (result != null) {
      setState(() {
  ...
  void _submit() {
    if (_layanan1 == null && _layanan2 == null && _layanan3 == null) {
    ...
    ScaffoldMessenger.of(context).showSnackBar(
      SnackBar(
        content: Text('Permohonan 3 in 1 berhasil diajukan',
            style: GoogleFonts.plusJakartaSans(fontSize: 13)),
                  ...
                  children: [
                    ...
                    _buildSection(
                      ...
                      children: [
                        ...
                        _dropdown(
                          ...
                          onChanged: (v) => setState(() => _statusPemohon = v),
                        ),
                        _gap(),
                    ...
                    _buildSection(
                      ...
                      children: [
                        ...
                        LayananSlot(
                          label: 'Layanan 1',
                          selectedLayanan: _layanan1,
                          onTap: () => _pickLayanan(1),
                        ),
                        _gap(),
                        LayananSlot(
                          label: 'Layanan 2',
                          selectedLayanan: _layanan2,
                          onTap: () => _pickLayanan(2),
                        ),
                        _gap(),
                        LayananSlot(
                          label: 'Layanan 3',
                          selectedLayanan: _layanan3,
